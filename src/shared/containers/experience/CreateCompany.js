...
import {experiences, techs} from '../../../store/models'
...
export default class CreateCompany extends Component {
  ...
  _handleSubmit = (back) => {
    ...
    const {logo, name, position, description, tech, fromMonth, fromYear, toMonth, toYear, isCurrent} = this.state
    ...
    post(experiences, data).then(res => {
